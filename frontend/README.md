# Frontend of Harsha's E-Learning Management System
...
- It has 3 modes of operation as **1) ADMIN 2) USER 3) TEACHER**
...
- view Teacher List, Course List, User List
- Accept or Reject the Teachers when they register as a new Teacher for this Portal
- Get various details on the admin dashboard as Total Teachers, Total Users, Total Learners, Total Courses, Most Liked Courses & Total Chapters added to the courses.

## Teacher Mode 

This mode makes you as a Teacher and you can perform various activities like...
- Teacher can register for a new account in-order to login to the portal
- Check the available User List 
- check the available courses 
- Add new Courses 
- View & Edit Teacher profile details
- Enroll any of you wished course and Teacher can also learn courses and make them as favourite
- check your registration approval as a valid Teacher by the ADMIN
- Add new Chapters for respective courses
- Get various details on the Teacher dashboard as Total Learners, Total Courses, Most Liked Courses & Total Chapters added to the courses.
